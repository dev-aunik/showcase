...
return [
    ...
    'We are developing low power consumption and economical IoT products for various applications. We have built a stable infrastructure that handles millions of data points every day.' => '多様なアプリケーション向け、低消費電力かつ経済的な IoT 製品を開発行っております。毎日、ミリオン単位のデーターポイント取扱っている安定したインフラ構築しております。',
    'Dashboard' => '管理者パネル（ダッシュボード）',
    'Branch Panel' => '各支店の管理パネル',
    'Customer Mobile Application' => 'ユーザー用モバイルアプリケーション',
    'Delivery Man Mobile Apllication' => '配送員用モバイルアプリケーション',
    'Inventory Management' => '売上・在庫等管理パネル',
    'Report Panel' => '各種帳票出力パネル',
    'Ticket Panel' => '追跡課題登録パネル',
    'Seller Panel' => 'ベンダーパネル',
    'Web Application' => 'Web アプリケーション',
    'Overview' => '概要',
    'GPS Attendance Mobile Application' => '出先でGPS出勤！',
    'Attendance Mobile Application' => '勤怠管理もアプリで！',
];
